        ...
        <Stack spacing = {1} direction='row'>
            <Box sx={classes.container}>
                ...
                <Box sx={classes.secbox}>
                  <Button variant="contained" onClick={() => navigate('/seller/register')}  size="large" sx={classes.sellerbutton}>SELLER</Button>
                  <Button variant="contained" onClick={() => navigate('/customer/register')}  size="large" sx={classes.viewbutton}>CUSTOMER</Button>
                </Box>
            </Box>
            <Box>
